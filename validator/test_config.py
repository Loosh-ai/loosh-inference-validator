...
def create_test_validator_config(yaml_config: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    test_env = {
        ...
        'LLM_API_URL': yaml_config.get('evaluation', {}).get('llm_api_url', 'https://api.openai.com/v1/chat/completions'),
        'LLM_MODEL': yaml_config.get('evaluation', {}).get('llm_model', 'gpt-3.5-turbo'),
